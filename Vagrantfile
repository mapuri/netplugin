...
echo "export no_proxy=192.168.2.10,192.168.2.11,localhost,127.0.0.0/8,netmaster" >> /etc/profile.d/envvar.sh
...
echo "Environment=\\\"no_proxy=192.168.2.10,192.168.2.11,localhost,127.0.0.0/8,netmaster\\\" \\\"http_proxy=$http_proxy\\\" \\\"https_proxy=$https_proxy\\\"" | sudo tee -a /etc/systemd/system/docker.service.d/http-proxy.conf
